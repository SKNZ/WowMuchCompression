...
{
	/**
	* CVideoLoader est une classe nous permettant d'importer des fichiers vidéos.
	...
	**/
	...
	/**
	  ...
	  * Un fichier créer par CCompressedVideoWriter doit donc être lu avec CCompressedVideoLoader.
	  * 
	  **/
